...
maps.n["<leader>pu"] = { function() require("lazy").check() end, desc = "Lazy open" }
maps.n["<leader>pU"] = { function() require("lazy").update() end, desc = "Lazy update" }
...
if is_available("zen-mode.nvim") then
    maps.n["<leader>uz"] = { function() ui.toggle_zen_mode() end, desc = "Zen mode" }
end
...
if is_available("alpha-nvim") then
    maps.n["<leader>h"] = {
        function()
            ...
            if
                #wins > 1
                and vim.api.nvim_get_option_value("filetype", { win = wins[1] }) == "neo-tree"
            then
...
if is_available("aerial.nvim") then
    maps.n["<leader>i"] = { function() require("aerial").toggle() end, desc = "Aerial" }
end
...
if is_available("nvim-dap") then
    ...
    maps.n["<S-F10>"] = { function() require("dap").step_back() end, desc = "Debugger: Step Back" }
    ...
    maps.n["<leader>do"] = { function() require("dap").step_back() end, desc = "Step Back (S-F10)" }
    maps.n["<leader>db"] = { function() require("dap").step_into() end, desc = "Step Into (F11)" }
    ...
    maps.n["<leader>dR"] = { function() require("dap").repl.toggle() end, desc = "REPL" }
    ...
    if is_available("nvim-dap-ui") then
        ...
        maps.x["<leader>dE"] = { function() require("dapui").eval() end, desc = "Evaluate Input" }
        maps.n["<leader>du"] = { function() require("dapui").toggle() end, desc = "Debugger UI" }
        maps.n["<leader>dh"] = {
...
function M.lsp_mappings(client, bufnr)
    ...
    lsp_mappings.n["<leader>lS"] =
        { function() vim.lsp.buf.workspace_symbol() end, desc = "Search symbol in workspace" }
    lsp_mappings.n["gS"] =
        { function() vim.lsp.buf.workspace_symbol() end, desc = "Search symbol in workspace" }
