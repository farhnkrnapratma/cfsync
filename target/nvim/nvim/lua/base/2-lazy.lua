...
local function get_lazy_spec()
    ...
    local snapshot_file_exists =
        vim.uv.fs_stat(vim.fn.stdpath("config") .. "/lua/" .. snapshot_filename .. ".lua")
    local spec = pin_plugins and snapshot_file_exists and { { import = snapshot_filename } } or {}
