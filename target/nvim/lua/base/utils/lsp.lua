...
M.apply_default_lsp_settings = function()
    ...
    M.lsp_hover_config = vim.g.lsp_round_borders_enabled and { border = "rounded", silent = true }
        or {}
...
function M.apply_user_lsp_settings(server_name)
    ...
    M.flags = {}
    local opts =
        vim.tbl_deep_extend("force", server, { capabilities = M.capabilities, flags = M.flags })
